...
public class RollOverCasesSearchServiceImpl implements IRollOverCasesSearchService
{
	...
	public Message<String> execute(Message<String> message) throws Throwable
	{
		...
		log.info("<----------------- inside RollOverCasesSearchServiceImpl -------------------->");
		...
		try
		{
			...
			searchRollOverCase(responseJSON, requestData, requestEntity, userActivity, communicationActivityService,
					systemUser);
	...
	private void searchRollOverCase(JSONObject responseJSON, JSONObject requestData, String entity,
			...
			throws JSONException
	{
		...
		try
		{
			...
			{
				responseJSON.put(JsonConstants.STATUS, JsonConstants.FAILURE);
				responseJSON.put(JsonConstants.MESSAGE, JsonConstants.MESSAGE_ROLLOVER_CASES_SEARCH_FAILURE);
				responseJSON.put(JsonConstants.DATA, "");
...
/*		if (dataMap.containsKey(XMLConstants.SALES_TAX_AMOUNT))
		...
		dataJSOn.put(JsonConstants.OD_PREMIUM_RATE, kgiConstant.getOdPremiumRate()==null?"":kgiConstant.getOdPremiumRate());
		
		dataJSOn.put(JsonConstants.TP_PREMIUM, kgiConstant.getTpPremiumRate()==null?"":kgiConstant.getTpPremiumRate());
		
		dataJSOn.put(JsonConstants.OWNER_DRIVER_PA, kgiConstant.getOwnerDriverPa()==null ? "":kgiConstant.getOwnerDriverPa());
		
		dataJSOn.put(JsonConstants.LIABILITY_TO_DRIVER, kgiConstant.getLegalLiabilityToDriver()==null?"":kgiConstant.getLegalLiabilityToDriver());
			...
			throws JSONException
	{
		...
		requestMap.put(XMLConstants.MESSAGE_TYPE, XMLConstants.MESSAGE_TYPE_MC0010);
		...
		wrapperMap.put(XMLConstants.MC0010, requestBodyXMLString);
