...
public class CasesSyncService implements ICasesSyncService
{
	...
	{
		log.info(" -------- In CasesSyncService Data / execute() -------- ");
		...
		try
		{
			...
			if (entity.equals(JsonConstants.CASES))
			{
				mapOutput = (Map<String, String>) applicationConfiguration.getValue(JsonConstants.CASES);
			}
		...
		{
			log.info(" -------- Error in CasesSyncService / execute -------- ");
