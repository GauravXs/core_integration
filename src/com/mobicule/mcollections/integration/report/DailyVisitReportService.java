...
public class DailyVisitReportService implements IDailyVisitReportService
{
		...
		try
		{
			...
			else
			{
				...
				if (data != null && userData != null) 
				{
					...
					DailyStatusCollectionReportMap = reportService.getDailyVisitCollectionReport(user, portFolio,
							fromDate, toDate);
