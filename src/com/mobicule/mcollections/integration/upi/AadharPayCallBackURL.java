...
import com.mobicule.mcollections.core.service.TransactionService;
import com.mobicule.mcollections.core.service.TransactionServiceImplementation;
import com.sun.servicetag.UnauthorizedAccessException;

public class AadharPayCallBackURL extends HttpServlet
{
			...
			IOException
	{
		...
		log.info("---AadharPayCallBackURL data----"+data);
		
		try {
		
		  TransactionServiceImplementation implementation=new TransactionServiceImplementation();
			
			log.info("---test---");
			
		 
			implementation.insertUPITrasaction(data, "UPICallBack");
